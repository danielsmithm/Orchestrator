...
public class TokenResources {
    ...
    private TokenDTO createToken(TokenCreationDTO tokenCreationDTO){
    ...
    private TokenDTO createToken(TokenValidationDTO tokenValidationDTO) throws TokenAlreadyValidatedException, InvalidTokenException, TokenNotFoundException {
